...
@section('page_title','Buyer Login')
@section('content')
...
<!-- //body header -->
<!-- form -->
<form form class="container" id="needs-validation" novalidate style="width:75%; margin:0 auto;" action= {{ route('buyer.login.submit') }}  method="POST">
    {{ csrf_field() }}
